...
WebUI.mouseOver(findTestObject('EditOrganisation/CertificateAndDocumentsObjects/1stitemonPage'))

WebUI.click(findTestObject('TagObjects/DeleteIcon'))

WebUI.click(findTestObject('TagObjects/DeleteBtnOnDialogueBox'))

WebUI.verifyElementNotPresent(findTestObject('TagObjects/DeleteBtnOnDialogueBox'), 0)
