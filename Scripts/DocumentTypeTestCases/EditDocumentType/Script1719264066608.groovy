...
WebUI.click(findTestObject('DocumentTypeObjects/CreatorDocuementSelector'))

WebUI.click(findTestObject('DocumentTypeObjects/DocumentEditBtn'))

WebUI.setText(findTestObject('DocumentTypeObjects/IssuanceDateField'), '12/03/2024')

WebUI.click(findTestObject('DocumentTypeObjects/SaveBtn'))

WebUI.waitForElementPresent(findTestObject('DocumentTypeObjects/DocumentEditBtn'), 9)
