...
WebUI.click(findTestObject('Object Repository/DocumentTypeObjects/MaterialObjects/span_add Add new'))

WebUI.setText(findTestObject('Object Repository/DocumentTypeObjects/MaterialObjects/input_Name_Name'), randomName)
