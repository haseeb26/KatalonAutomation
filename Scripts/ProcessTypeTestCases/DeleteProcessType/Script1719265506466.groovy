...
WebUI.click(findTestObject('Object Repository/DocumentTypeObjects/MaterialObjects/span_Admin'))

WebUI.click(findTestObject('Object Repository/ProcessTypeObjects/Page_Interu/div_shuffleProcess typesDefine process type_23a271'))

WebUI.click(findTestObject('Object Repository/DocumentTypeObjects/Page_Interu/span_Silent Batman_mat-mdc-button-touch-target'))

WebUI.click(findTestObject('Object Repository/DocumentTypeObjects/Page_Interu/span_deleteDelete'))
